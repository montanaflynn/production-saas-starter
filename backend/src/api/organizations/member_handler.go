...
// @Accept json
// @Produce json
// @Param request body github_com_moasq_backend_app_organizations_app_services.BootstrapOrganizationRequest true "Organization bootstrap request (passwordless - no password required)"
// @Success 201 {object} github_com_moasq_backend_app_organizations_app_services.BootstrapOrganizationResponse
...
// @Success 201 {object} github_com_moasq_backend_app_organizations_app_services.AddMemberResponse
...
// @Accept json
// @Produce json
// @Success 200 {object} github_com_moasq_backend_app_organizations_app_services.ListMembersResponse
...
// @Accept json
// @Produce json
// @Success 200 {object} github_com_moasq_backend_app_organizations_app_services.ProfileResponse
