...
import (
	...
	"github.com/moasq/backend/pkg/api/response"
...
// @Tags RBAC
// @Produce json
// @Success 200 {object} github_com_moasq_backend_pkg_auth.RolesResponse "Roles with permissions"
...
// @Tags RBAC
// @Produce json
// @Success 200 {object} github_com_moasq_backend_pkg_auth.PermissionsResponse "All permissions"
// @Failure 500 {object} map[string]string "Internal error"
...
// @Tags RBAC
// @Produce json
// @Success 200 {object} github_com_moasq_backend_pkg_auth.PermissionsByCategoryResponse "Permissions by category"
// @Failure 500 {object} map[string]string "Internal error"
...
// @Success 200 {object} github_com_moasq_backend_pkg_auth.RolePermissionsResponse "Role details with statistics"
...
// @Accept json
// @Produce json
// @Param body body github_com_moasq_backend_pkg_auth.PermissionCheckRequest true "Role and permission to check"
// @Success 200 {object} github_com_moasq_backend_pkg_auth.PermissionCheckResponse "Permission check result"
...
// @Tags RBAC
// @Produce json
// @Success 200 {object} github_com_moasq_backend_pkg_auth.RBACMetadata "RBAC system metadata"
